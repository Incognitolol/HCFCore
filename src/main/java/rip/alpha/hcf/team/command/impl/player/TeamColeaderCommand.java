...
public class TeamColeaderCommand {
    @Command(names = {"team coleader", "t coleader", "f coleader", "faction coleader"}, async = true)
    public static void teamColeaderCommand(Player player, @Param(name = "target") UUID targetUUID) {
        ...
        int targetRole = PlayerTeam.TeamMember.TEAM_COLEADER;
