...
public class TeamCaptainCommand {
    @Command(names = {"team captain", "t captain", "f captain", "faction captain"}, async = true)
    public static void teamCaptain(Player player, @Param(name = "target") UUID targetUUID) {
        ...
        int targetRole = PlayerTeam.TeamMember.TEAM_CAPTAIN;
